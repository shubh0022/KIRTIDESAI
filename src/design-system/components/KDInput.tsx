...
interface KDInputProps extends React.InputHTMLAttributes<HTMLInputElement> {
  label?: string;
  error?: string;
  helperText?: string;
  required?: boolean;
...
export default function KDInput({
  label,
  error,
  helperText,
  required,
  ...
  return (
    <div className="space-y-1.5 w-full">
      ...
      <input
        ...
        required={required}
        className={`
          w-full p-3 bg-white/80 border text-xs text-[#171717] font-mono
          ...
          placeholder:text-[#171717]/35 placeholder:font-sans
